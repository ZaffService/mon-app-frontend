(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))r(a);new MutationObserver(a=>{for(const o of a)if(o.type==="childList")for(const i of o.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&r(i)}).observe(document,{childList:!0,subtree:!0});function n(a){const o={};return a.integrity&&(o.integrity=a.integrity),a.referrerPolicy&&(o.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?o.credentials="include":a.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function r(a){if(a.ep)return;a.ep=!0;const o=n(a);fetch(a.href,o)}})();function c(e,t="info"){document.querySelectorAll(".toast").forEach(o=>o.remove());const r=document.createElement("div"),a={success:"#25D366",error:"#ef4444",info:"#8696a0",warning:"#f59e0b"};r.className="toast fixed right-4 top-4 p-4 rounded-lg text-white shadow-lg transform translate-x-full transition-all duration-300 z-50",r.style.backgroundColor=a[t],r.innerHTML=`
  ...
  `,r.appendChild(a),setTimeout(()=>{a.style.transform="translateX(0)"},100),setTimeout(()=>{a.style.transform="translateX(100%)",setTimeout(()=>{a.parentElement&&a.remove()},300)},5e3),K()}function K(){try{const e=new(window.AudioContext||window.webkitAudioContext),t=e.createOscillator(),n=e.createGain();t.connect(n),n.connect(e.destination),t.frequency.setValueAtTime(800,e.currentTime),t.frequency.setValueAtTime(600,e.currentTime+.1),n.gain.setValueAtTime(.1,e.currentTime),n.gain.exponentialRampToValueAtTime(.01,e.currentTime+.2),t.start(e.currentTime),t.stop(e.currentTime+.2)}catch(e){console.log("Impossible de jouer le son de notification:",e)}}async function Z(){try{return await Notification.requestPermission()==="granted"}catch(e){return console.error("Erreur permissions notifications:",e),!1}}const h="http://localhost:5001";async function A(){try{const e=await fetch(`${h}/chats`);if(!e.ok)throw new Error("Erreur réseau");return await e.json()}catch(e){throw console.error("Erreur getChats:",e),e}}async function j(e){try{const t=await fetch(`${h}/chats/${e}`);if(!t.ok)throw new Error("Erreur réseau");return(await t.json()).messages||[]}catch(t){return console.error("Erreur getMessages:",t),[]}}async function L(e,t){try{const n=await fetch(`${h}/chats/${e}`);if(!n.ok)return console.error(`Chat ${e} non trouvé, création...`),await _(e,t);const r=await n.json();r.messages=r.messages||[],r.messages.push(t);const a=await fetch(`${h}/chats/${e}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(r)});if(!a.ok)throw new Error("Erreur mise à jour");return await a.json()}catch(n){throw console.error("Erreur addMessage:",n),n}}async function C(e,t){try{const n=await fetch(`${h}/chats/${e}`);if(!n.ok)return console.warn(`Chat ${e} non trouvé pour mise à jour`),null;const r=await n.json();Object.assign(r,t);const a=await fetch(`${h}/chats/${e}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(r)});if(!a.ok)throw new Error("Erreur mise à jour");return await a.json()}catch(n){return console.error("Erreur updateChat:",n),null}}async function _(e,t){try{const n={id:e,name:`User ${e}`,avatar:"https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&h=150&fit=crop&crop=face",messages:[t],lastMessage:t.text,time:t.time,lastMessageTime:t.timestamp,unread:0,isOnline:!1},r=await fetch(`${h}/chats`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(n)});if(!r.ok)throw new Error("Erreur création chat");return await r.json()}catch(n){throw console.error("Erreur createChatForUser:",n),n}}async function Q(e,t){try{const n=await fetch(`${h}/chats/${e}`);if(!n.ok)return;const r=await n.json();r.isOnline=t,r.lastSeen=new Date().toISOString(),await fetch(`${h}/chats/${e}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(r)})}catch(n){console.error("Erreur updateUserStatus:",n)}}let F=null;function Y(){const e=localStorage.getItem("currentUser");if(e)try{const t=JSON.parse(e);return H(t),t}catch(t){console.error("Erreur parsing user:",t),localStorage.removeItem("currentUser")}return null}function g(){return F||Y()}function H(e){F=e,e?(localStorage.setItem("currentUser",JSON.stringify(e)),Q(e.id,"en ligne").catch(console.error)):localStorage.removeItem("currentUser")}function ee(){window.refreshInterval&&clearInterval(window.refreshInterval),localStorage.removeItem("currentUser"),window.location.reload()}async function te(e,t){try{if(!e||!t)return c("Veuillez remplir tous les champs","error"),null;if(t.length!==9||!/^\d+$/.test(t))return c("Le numéro doit contenir exactement 9 chiffres","error"),null;const r=(await A()).find(a=>a.name.toLowerCase().trim()===e.toLowerCase().trim()&&a.phone.trim()===t.trim());return r?(H(r),c(`Bienvenue ${r.name}!`,"success"),r):(c("Nom ou téléphone incorrect","error"),null)}catch(n){return console.error("Erreur de connexion:",n),c("Erreur de connexion au serveur","error"),null}}function ne(e){const t=document.createElement("div");t.className="min-h-screen flex items-center justify-center bg-[#111b21] px-4",t.innerHTML=`
  ...
  `;const n=t.querySelector("#loginForm"),r=t.querySelector("#nameInput"),a=t.querySelector("#phoneInput"),o=t.querySelector("#loginButton");return a.addEventListener("input",i=>{i.target.value=i.target.value.replace(/[^0-9]/g,"")}),n.addEventListener("submit",async i=>{i.preventDefault();const u=r.value.trim(),b=a.value.trim();if(!u||!b){c("Veuillez remplir tous les champs","error");return}o.disabled=!0,o.innerHTML=`
    ...
    `;try{const E=await te(u,b);E&&e&&e(E)}finally{o.disabled=!1,o.textContent="Se connecter"}}),t}let l=null,B=null,m=null;function re(e){if(l){c("Un appel est déjà en cours","error");return}console.log("Initialisation appel audio avec:",e.name),q(e,"audio")}function ae(e){if(l){c("Un appel est déjà en cours","error");return}console.log("Initialisation appel vidéo avec:",e.name),q(e,"video")}async function q(e,t){if(l={contact:e,type:t,startTime:Date.now(),status:"calling"},t==="video")try{console.log("Demande d'accès à la caméra..."),m=await navigator.mediaDevices.getUserMedia({video:!0,audio:!0}),console.log("✅ Accès caméra accordé")}catch(r){console.error("❌ Erreur accès caméra:",r),c("Veuillez autoriser l'accès à la caméra","error");return}se(e,t),t==="video"&&m&&oe(),de();const n=Math.random()*3e3+2e3;B=setTimeout(()=>{l&&l.status==="calling"&&ce()},n)}function se(e,t){const n=document.getElementById("callInterface");n&&n.remove();const r=document.createElement("div");r.id="callInterface",r.className="fixed inset-0 bg-gray-900 z-50",t==="video"?r.innerHTML=`
    ...
    `,document.body.appendChild(r),ie()}function oe(){const e=document.getElementById("localVideo");e&&m?(console.log("🎥 Configuration de votre caméra..."),e.srcObject=m,e.play().then(()=>{console.log("✅ Votre caméra est active")}).catch(t=>{console.error("❌ Erreur démarrage caméra:",t)})):console.error("❌ Vidéo ou stream manquant")}function ie(){const e=document.getElementById("muteBtn"),t=document.getElementById("cameraBtn"),n=document.getElementById("speakerBtn"),r=document.getElementById("hangupBtn");let a=!1,o=!1;e&&e.addEventListener("click",()=>{a=!a,m&&m.getAudioTracks().forEach(i=>{i.enabled=!a}),e.innerHTML=`<i class="fas fa-microphone${a?"-slash":""} text-xl text-white"></i>`,e.classList.toggle("bg-red-500",a),c(a?"🔇 Micro coupé":"🎤 Micro activé","info")}),t&&t.addEventListener("click",()=>{o=!o,m&&m.getVideoTracks().forEach(i=>{i.enabled=!o}),t.innerHTML=`<i class="fas fa-video${o?"-slash":""} text-xl text-white"></i>`,t.classList.toggle("bg-red-500",o),c(o?"📹 Caméra désactivée":"🎥 Caméra activée","info")}),n&&n.addEventListener("click",()=>{c("🔊 Haut-parleur","info")}),r&&r.addEventListener("click",fe)}function ce(){if(!l)return;l.status="connected",l.connectedTime=Date.now(),ue();const e=document.getElementById("callStatus");e&&(e.textContent=l.type==="video"?"📹 Appel vidéo connecté":"📞 Appel connecté"),le(),c("✅ Appel connecté","success")}function le(){const e=document.getElementById("callDuration");if(!e||!l)return;const t=()=>{if(!l||l.status!=="connected")return;const n=Math.floor((Date.now()-l.connectedTime)/1e3),r=Math.floor(n/60),a=n%60;e.textContent=`${r.toString().padStart(2,"0")}:${a.toString().padStart(2,"0")}`};t(),l.timerInterval=setInterval(t,1e3)}function de(){console.log("🔔 Sonnerie...")}function ue(){console.log("🔕 Arrêt sonnerie")}async function fe(){if(!l)return;const e=l.status==="connected",t=e&&l.connectedTime?Math.floor((Date.now()-l.connectedTime)/1e3):0;B&&(clearTimeout(B),B=null),l.timerInterval&&clearInterval(l.timerInterval),m&&(m.getTracks().forEach(r=>{r.stop()}),m=null),e&&await me(l.contact,l.type,t);const n=document.getElementById("callInterface");if(n&&n.remove(),t>0){const r=Math.floor(t/60),a=t%60;c(`📞 Appel terminé - ${r}:${a.toString().padStart(2,"0")}`,"info")}else c("📞 Appel annulé","info");l=null}async function me(e,t,n){try{const r=g();if(!r||!window.currentChat)return;const a=Math.floor(n/60),o=n%60,i=`${a}:${o.toString().padStart(2,"0")}`,u={id:Date.now(),senderId:r.id,receiverId:e.id,text:`${t==="video"?"📹 Appel vidéo":"📞 Appel vocal"} - ${i}`,sent:!0,time:new Date().toLocaleTimeString("fr-FR",{hour:"2-digit",minute:"2-digit"}),timestamp:new Date().toISOString(),type:"call",callType:t,duration:n,status:"sent"};window.sendMessage&&await window.sendMessage(u)}catch(r){console.error("Erreur envoi message d'appel:",r)}}const U=new Map;let T=null,$=null,k=null;function ge(e,t){$=e,k=t,T&&clearInterval(T),T=setInterval(pe,2e3),console.log("Synchronisation temps réel initialisée")}async function pe(){try{const e=he();if(!e)return;const n=await(await fetch("http://localhost:5001/chats")).json();for(const r of n){if(r.id===e.id)continue;const a=r.messages||[],o=U.get(r.id)||0;if(a.length>o){const i=a.slice(o);for(const u of i)u.receiverId===e.id&&u.senderId===r.id&&$&&$(u);U.set(r.id,a.length)}}if(k)for(const r of n)r.id!==e.id&&k(r.id,r.isOnline||!1)}catch(e){console.error("Erreur synchronisation temps réel:",e)}}function he(){const e=localStorage.getItem("currentUser");return e?JSON.parse(e):null}async function V(e,t,n){try{await L(e,n);const r={...n,sent:!1,senderId:e,receiverId:t};await L(t,r);const a={lastMessage:n.type==="text"?n.text:ve(n),time:n.time,lastMessageTime:n.timestamp};return await C(e,a),await C(t,a),console.log("Message envoyé avec succès"),!0}catch(r){throw console.error("Erreur envoi message:",r),r}}function ve(e){switch(e.type){case"image":return"📷 Photo";case"video":return"🎥 Vidéo";case"audio":return"🎵 Audio";case"voice":return"🎤 Message vocal";case"document":return`📎 ${e.fileName}`;default:return e.text}}function ye(){console.log("Audio recorder configuré")}let v=[],s=null;window.currentChat=null;document.addEventListener("DOMContentLoaded",()=>{console.log("Application démarrée"),xe()});async function xe(){const e=document.getElementById("mainContainer"),t=document.getElementById("loginContainer"),n=g();n?(console.log("Utilisateur connecté:",n.name),a()):(console.log("Aucun utilisateur connecté"),r());function r(){e.style.display="none",t.style.display="block",t.innerHTML="";const o=ne(i=>{console.log("Connexion réussie pour:",i.name),a()});t.appendChild(o)}function a(){t.style.display="none",e.style.display="flex",we()}}async function we(){try{await be(),Ee(),De(),R(),ge(Ge,Ke),Ze(),ye(),console.log("Interface principale initialisée")}catch(e){console.error("Erreur initialisation:",e),c("Erreur de chargement","error")}}async function be(){try{if(v=await A(),y(),s){const e=await j(s.id);w(e)}}catch(e){console.error("Erreur chargement chats:",e),c("Impossible de charger les conversations","error")}}function Ee(){const e=document.getElementById("userAvatarButton");e&&e.addEventListener("click",je);const t=document.getElementById("backToChats");t&&t.addEventListener("click",P);const n=document.getElementById("logoutButton");n&&n.addEventListener("click",ee);const r=document.getElementById("backButton");r&&r.addEventListener("click",Pe),Ve(),Re(),Ie(),Be(),Ce(),Me(),window.addEventListener("resize",ze),Z(),Xe()}function Ie(){const e=document.getElementById("searchInput");e&&e.addEventListener("input",t=>{const n=t.target.value.toLowerCase().trim();$e(n)})}function Be(){const e=document.querySelectorAll(".filter-tab");e.forEach(t=>{t.addEventListener("click",()=>{e.forEach(r=>{r.classList.remove("active","bg-green-600","text-white"),r.classList.add("text-gray-400")}),t.classList.add("active","bg-green-600","text-white"),t.classList.remove("text-gray-400");const n=t.dataset.filter;ke(n)})})}function Ce(){const e=document.getElementById("voiceCallBtn"),t=document.getElementById("videoCallBtn");e&&e.addEventListener("click",()=>{s&&re(s)}),t&&t.addEventListener("click",()=>{s&&ae(s)})}function Me(){const e=document.getElementById("attachBtn"),t=document.getElementById("fileInput");e&&t&&(e.addEventListener("click",()=>{t.click()}),t.addEventListener("change",Te))}async function Te(e){const t=e.target.files[0];if(!(!t||!s))try{const n=await Se(t),r={id:Date.now(),text:t.name,sent:!0,time:new Date().toLocaleTimeString("fr-FR",{hour:"2-digit",minute:"2-digit"}),timestamp:new Date().toISOString(),type:Le(t.type),fileData:n,fileName:t.name,fileSize:t.size,status:"sent"};await J(r),e.target.value=""}catch(n){console.error("Erreur upload fichier:",n),c("Erreur lors de l'envoi du fichier","error")}}function Se(e){return new Promise((t,n)=>{const r=new FileReader;r.readAsDataURL(e),r.onload=()=>t(r.result),r.onerror=a=>n(a)})}function Le(e){return e.startsWith("image/")?"image":e.startsWith("video/")?"video":e.startsWith("audio/")?"audio":"document"}function $e(e){document.querySelectorAll(".chat-item").forEach(n=>{var o,i;const r=((o=n.querySelector(".chat-name"))==null?void 0:o.textContent.toLowerCase())||"",a=((i=n.querySelector(".chat-message"))==null?void 0:i.textContent.toLowerCase())||"";r.includes(e)||a.includes(e)?n.style.display="block":n.style.display="none"})}function ke(e){const t=g();if(!t)return;let n=v.filter(r=>r.id!==t.id);switch(e){case"unread":n=n.filter(r=>r.unread>0);break;case"favorites":n=n.filter(r=>r.isFavorite);break;case"groups":n=n.filter(r=>r.isGroup);break}Ae(n)}function Ae(e){const t=document.getElementById("chatList");t&&(t.innerHTML="",e.forEach(n=>{const r=z(n);t.appendChild(r)}))}function je(){const e=document.getElementById("sidebar"),t=document.getElementById("profilePanel"),n=document.getElementById("chatArea");e.style.display="none",n.style.display="none",t.style.display="flex",Ne()}function P(){const e=document.getElementById("sidebar"),t=document.getElementById("profilePanel"),n=document.getElementById("chatArea");t.style.display="none",e.style.display="flex",s&&(n.style.display="flex")}function Ne(){const e=g();if(e){const t=document.getElementById("profileImage"),n=document.getElementById("profileName");t&&(t.src=e.avatar,t.alt=e.name),n&&(n.textContent=e.name)}}function De(){const e=g(),t=document.querySelectorAll(".user-avatar img");e&&t.length>0&&t.forEach(n=>{n.src=e.avatar,n.alt=e.name})}function R(){const e=document.getElementById("messagesArea");e&&(e.innerHTML=`
  ...
  `,t.addEventListener("click",()=>Ue(e.id)),t}async function Ue(e){var t;P(),s=v.find(n=>n.id===e),window.currentChat=s,s&&(s.unread>0&&(s.unread=0,await C(s)),document.querySelectorAll(".chat-item").forEach(n=>{n.classList.remove("bg-[#202c33]")}),(t=document.querySelector(`[data-chat-id="${e}"]`))==null||t.classList.add("bg-[#202c33]"),N()&&(document.getElementById("sidebar").style.display="none"),document.getElementById("chatArea").style.display="flex",Oe(),await w(),qe(),y())}function Oe(){const e=document.getElementById("chatHeader"),t=document.getElementById("chatAvatar"),n=document.getElementById("chatName"),r=document.getElementById("chatStatus");e&&s&&(e.style.display="flex",t.innerHTML=`<img src="${s.avatar}" alt="${s.name}" class="w-10 h-10 rounded-full object-cover">`,n.textContent=s.name,r.textContent=s.isOnline?"en ligne":s.status)}async function w(){const e=document.getElementById("messagesArea");if(!(!e||!s))try{const t=await j(s.id);s.messages=t,e.innerHTML="",t.forEach(n=>{const r=Fe(n);e.appendChild(r)}),e.scrollTop=e.scrollHeight}catch(t){console.error("Erreur lors du rendu des messages:",t),c("Erreur lors du chargement des messages","error")}}function Fe(e){const t=g(),n=e.senderId===t.id||e.sent===!0,r=document.createElement("div");r.className=`flex mb-4 ${n?"justify-end":"justify-start"}`,r.dataset.messageId=e.id;let a="";switch(e.type){case"image":a=`
